...
spark = (
    SparkSession.builder.appName("SupplierDataToGCSLanding")
...
def save_logs_to_gcs():
    ...
    """
    log_filename = (
        f"supplier_pipeline_log_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}.json"
    )
...
def move_existing_files_to_archive(table_name: str, target_path: str):
    ...
    for file in existing_files:
        ...
        date_part = file.split("_")[-1].split(".")[
            0
        ]  # ex: ../../suppliers_12062025.json -> 12062025
