...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-datalake/landing/retailer-db/order_items/*.json']
);
-------------------------------------------------------------------------------------------------------------
-- Suppliers Table
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-datalake/landing/supplier-db/suppliers/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-datalake/landing/supplier-db/product_suppliers/*.json']
);
...
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://retailer-datalake/landing/customer_reviews/customer_reviews_*.parquet']
);